  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600">
              We combine deep knowledge of Australian education with tailored support in Vietnamese to deliver confident study abroad journeys.
            </p>
          </div>
      ...
      <section className="relative isolate overflow-hidden py-24 text-white">
        ...
        <Image
          alt="Students celebrating in Australia"
          src="/images/Study-in-Australia-Testimonial.webp"
          fill
          priority
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <h2 className="max-w-3xl text-3xl font-bold sm:text-4xl">Real stories from Vietnamese students thriving in Australia</h2>
            <p className="max-w-2xl text-blue-100">
              Hear how our mentorship transformed uncertainty into scholarships, visa approvals, and successful careers across Australia.
            </p>
          </div>
      ...
      <section className="py-20 bg-blue-50">
        <div className="container mx-auto px-4">
          <div className="mb-12 max-w-3xl text-center md:mx-auto">
            <span className="text-sm font-semibold uppercase tracking-widest text-blue-700">Why Australia stands out</span>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold text-gray-900 sm:text-4xl">Your roadmap from dream to Australian campus</h2>
          </div>
      ...
      <section className="relative overflow-hidden bg-slate-900 py-24 text-white">
        ...
        <div className="container relative mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="mt-4 max-w-3xl text-3xl font-bold sm:text-4xl">Everything Vietnamese parents ask before choosing Australia</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl rounded-3xl border border-white/20 bg-white/10 p-10 text-center backdrop-blur-md">
            ...
            <p className="mt-4 text-blue-100">
              Share your study goals and receive a personalised Australian study pathway in 48 hours—complete with scholarship options and visa roadmap.
            </p>
...
const chooseUsHighlights = [
  {
    ...
    title: 'Subclass 500 visa success specialists',
    description: 'Meticulous documentation reviews and weekly mock interviews keep our approval rate above the Australian average.'
  },
  {
    icon: GraduationCap,
    stat: '120+',
    ...
    description: 'We align your academic strengths with faculty-specific scholarships across Go8 and tech-focused universities.'
  },
  {
    icon: HeartHandshake,
    stat: '12',
    statLabel: 'Years guiding families',
    title: 'Advisors who studied and lived in Australia',
  ...
  },
  {
    ...
    description: 'Receive priority application reviews thanks to long-term collaborations with leading Australian institutions.'
  }
]
...
const testimonials = [
  {
    ...
    university: 'Master of Analytics, University of Melbourne',
    story:
      '“The team coached me through IELTS from 6.5 to 7.5 and helped negotiate a 30% tuition scholarship. I landed an internship in my first trimester.”',
    result: 'Now working part-time at a Melbourne data consultancy',
    image:
      'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.1.0&auto=format&fit=crop&w=400&q=80'
  },
  {
    name: 'Trần Quỳnh Mai',
    university: 'Bachelor of Nursing, University of Technology Sydney',
    story:
      '“My parents were nervous about visa risks. The advisors handled financial proof, health checks, and even arranged student housing in Ultimo.”',
    result: 'Visa issued in 18 days • Currently a casual nurse at Royal Prince Alfred Hospital',
    image:
  ...
  {
    name: 'Phạm Minh Đức',
    university: 'Bachelor of Information Technology, RMIT University',
    story:
      '“They mapped out my coding portfolio, arranged alumni interviews, and secured me a 20% Dean’s scholarship despite limited extracurriculars.”',
    result: 'Intern software engineer at a Melbourne fintech start-up',
    image:
...
const quickFacts = [
  {
    ...
    description: 'Business and IT programs typically range from AUD 25,000 – 32,000 depending on institution and city.'
  },
  {
    icon: CalendarCheck,
    value: '2 years',
    label: 'Post-study work rights',
    description: 'Graduates from Australian bachelor programmes secure a minimum 2-year Temporary Graduate visa (subclass 485).'
  },
  {
    icon: Compass,
    value: 'Top 8',
    label: 'Global climate ranking',
    description: 'Mild winters in Sydney and Melbourne make the transition from Hanoi or HCMC climates gentler for students.'
  },
  {
    icon: Star,
    value: '24 hrs/week',
    label: 'Work during study',
    description: 'Student visas allow up to 48 hours per fortnight during semester and unlimited hours in official breaks.'
  }
]
...
const processSteps = [
  {
    ...
    description: 'We audit your academics, finances, and English level, then co-create a shortlist of universities and scholarships.'
  },
  {
    icon: GraduationCap,
    title: 'Application preparation',
    description: 'Statement of purpose workshops, recommendation coaching, and certified document translations in Vietnamese and English.'
  },
  {
    icon: ShieldCheck,
    title: 'Visa & compliance',
    description: 'GTE interview practice, financial evidence review, and health insurance setup with weekly progress updates.'
  },
  {
    icon: Plane,
    title: 'Arrival & settlement',
    description: 'Airport pick-up coordination, housing guidance, TFN/bank setup, and introductions to Vietnamese alumni groups.'
  }
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Most Vietnamese applicants need evidence covering one year of tuition plus AUD 24,505 for living expenses. We help structure bank certificates and sponsor letters correctly.'
  },
  {
    question: 'Can I work while studying?',
    answer:
      'Yes. Student visas allow 48 hours of work per fortnight during semester and unlimited hours in designated breaks. We provide resume and job search support before you arrive.'
  },
  {
    question: 'How long does the process take from consultation to departure?',
    answer:
      'Typically 4–6 months: 2 months for university offers, 2 months for COE and visa, plus 2–4 weeks for pre-departure preparation depending on your intake.'
  }
]
