...
export default function UniversityOfGottingenPage() {
    return (
        <main className="bg-white">
            <section className="relative isolate overflow-hidden text-white">
                <Image
                    alt="University of Göttingen campus"
                    src={heroImage}
                    fill
                    priority
                ...
                <div className="container mx-auto px-4 py-24 sm:py-28 lg:py-32">
                    <div className="max-w-3xl space-y-6">
                        <span className="inline-flex items-center rounded-full border border-white/30 px-4 py-1 text-sm uppercase tracking-widest">
                            Excellence University • Göttingen, Lower Saxony
                        </span>
                        <h1 className="text-4xl font-bold sm:text-5xl">University of Göttingen</h1>
                        <p className="text-lg text-blue-100">
                            A prestigious research university with an illustrious history of Nobel Prize winners, offering excellence in natural sciences, medicine, humanities, and social sciences.
                        </p>
                        <div className="flex flex-wrap gap-4 text-sm text-blue-100/90">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                Historic university town • Central Germany
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid gap-4 rounded-2xl border border-blue-100 bg-blue-50/40 p-6 text-sm text-blue-900">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p>Natural Sciences • Medicine • Humanities • Social Sciences</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Compass className="mt-1 size-5" aria-hidden />
                                <div>
                                    <p className="font-semibold">Nobel tradition</p>
                                    <p>45 Nobel Prize winners associated with the university.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div className="mx-auto max-w-3xl rounded-3xl border border-blue-100 bg-blue-50/50 p-10 text-center">
                        <h2 className="text-3xl font-semibold text-gray-900">Plan your Göttingen pathway with us</h2>
...
const highlights = [
    {
        ...
        description: "45 Nobel Prize winners and leading research in physics, chemistry, and mathematics.",
        icon: Star,
    },
    {
        title: "Historic libraries",
        description: "Access to one of Germany's largest university libraries with millions of volumes.",
        icon: MapPin,
    },
    {
        title: "Student-centered",
        description: "Intimate university town atmosphere with strong student support services.",
        icon: Compass,
    },
]
