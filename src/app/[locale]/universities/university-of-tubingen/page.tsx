...
export default function UniversityOfTubingenPage() {
    return (
        <main className="bg-white">
            <section className="relative isolate overflow-hidden text-white">
                <Image
                    alt="University of Tübingen campus"
                    src={heroImage}
                    fill
                    priority
                ...
                <div className="container mx-auto px-4 py-24 sm:py-28 lg:py-32">
                    <div className="max-w-3xl space-y-6">
                        <span className="inline-flex items-center rounded-full border border-white/30 px-4 py-1 text-sm uppercase tracking-widest">
                            Excellence University • Tübingen, Baden-Württemberg
                        </span>
                        <h1 className="text-4xl font-bold sm:text-5xl">University of Tübingen</h1>
                        <p className="text-lg text-blue-100">
                            A historic university town offering world-class education in medicine, theology, natural sciences, and humanities with a strong research tradition dating back to 1477.
                        </p>
                        <div className="flex flex-wrap gap-4 text-sm text-blue-100/90">
                            <div className="flex items-center gap-2">
                                <Star className="size-4" aria-hidden />
                                #10 in Germany (THE 2025)
                            </div>
                            <div className="flex items-center gap-2">
                                <MapPin className="size-4" aria-hidden />
                                Medieval town • Neckar Valley
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid gap-4 rounded-2xl border border-blue-100 bg-blue-50/40 p-6 text-sm text-blue-900">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p>Medicine • Theology • Natural Sciences • Humanities</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p>Leading in neuroscience, AI, and molecular biology research.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div className="mx-auto max-w-3xl rounded-3xl border border-blue-100 bg-blue-50/50 p-10 text-center">
                        <h2 className="text-3xl font-semibold text-gray-900">Plan your Tübingen pathway with us</h2>
...
const highlights = [
    {
        ...
        description: "One of Germany's top medical schools with world-renowned research hospitals.",
        icon: Star,
    },
    {
        title: "Student-friendly town",
        description: "Charming medieval town with affordable living and vibrant student culture.",
        icon: MapPin,
    },
    {
        title: "AI & neuroscience",
        description: "Leading research in artificial intelligence and cognitive neuroscience.",
        icon: Compass,
    },
]
