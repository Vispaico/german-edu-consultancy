...
export default function UniversityOfBonnPage() {
    return (
        <main className="bg-white">
            <section className="relative isolate overflow-hidden text-white">
                <Image
                    alt="University of Bonn campus"
                    src={heroImage}
                    fill
                    priority
                ...
                <div className="container mx-auto px-4 py-24 sm:py-28 lg:py-32">
                    <div className="max-w-3xl space-y-6">
                        <span className="inline-flex items-center rounded-full border border-white/30 px-4 py-1 text-sm uppercase tracking-widest">
                            Excellence University • Bonn, North Rhine-Westphalia
                        </span>
                        <h1 className="text-4xl font-bold sm:text-5xl">University of Bonn</h1>
                        <p className="text-lg text-blue-100">
                            One of Germany&apos;s most prestigious universities with a rich history and excellence in research, particularly in mathematics, physics, economics, and law.
                        </p>
                        <div className="flex flex-wrap gap-4 text-sm text-blue-100/90">
                            <div className="flex items-center gap-2">
                                <Star className="size-4" aria-hidden />
                                #8 in Germany (THE 2025)
                            </div>
                            <div className="flex items-center gap-2">
                                <MapPin className="size-4" aria-hidden />
                                Former capital • Rhine Valley
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid gap-4 rounded-2xl border border-blue-100 bg-blue-50/40 p-6 text-sm text-blue-900">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p>Law • Economics • Medicine • Natural Sciences</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Compass className="mt-1 size-5" aria-hidden />
                                <div>
                                    <p className="font-semibold">Research clusters</p>
                                    <p>Mathematics, immunology, and economics research excellence.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div className="mx-auto max-w-3xl rounded-3xl border border-blue-100 bg-blue-50/50 p-10 text-center">
                        <h2 className="text-3xl font-semibold text-gray-900">Plan your Bonn pathway with us</h2>
...
const highlights = [
    {
        title: "Nobel Prize tradition",
        description: "Home to numerous Nobel laureates with a strong tradition of groundbreaking research.",
        icon: Star,
    },
    {
        title: "International programs",
        description: "Extensive English-taught master's programs and global exchange partnerships.",
        icon: MapPin,
    },
    {
        title: "Quality of life",
        description: "Beautiful Rhine Valley location with affordable living costs and excellent public transport.",
        icon: Compass,
    },
]
