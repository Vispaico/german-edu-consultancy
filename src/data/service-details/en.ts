...
export const serviceDetailsEn: Record<ServiceSlug, ServiceDetail> = {
  ...
  'test-preparation': {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Progress tracking, global mentor check-ins, and milestone rewards keep you motivated.',
      },
    ],
    focus: {
      eyebrow: 'Structured learning',
      title: 'Modular German courses that fit your school schedules',
      description:
    ...
    support: {
      ...
      description:
        'Join study groups led by global alumni who passed TestDaF/DSH and access official practice tests updated for current exam formats.',
      bullets: [
